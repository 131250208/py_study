...
class Request:
    def getIPs(self):
        ...
        print ips_list
        print u'获取到ip:' + str(len(ips_list)) + u"个"
        
        return ips_list
    
    def __init__(self):
        # 爬取代理ip
        self.iplist = self.getIPs()
        ...
        self.user_agent_list = [
            ...
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.79 Safari/537.36 Edge/14.14393",# ie
            "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.122 Safari/537.36 SE 2.X MetaSr 1.0",# 搜狗
            "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Maxthon/4.9.3.1000 Chrome/39.0.2146.0 Safari/537.36",# 遨游云
